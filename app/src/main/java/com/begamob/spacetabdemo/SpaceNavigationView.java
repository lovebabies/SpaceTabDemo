...
public class SpaceNavigationView extends RelativeLayout {
    ...
    private void initAndAddViewsToMainView() {
        ...
        centreButton.setBackgroundTintList(ColorStateList.valueOf(Color.parseColor("#31DB9F")));
//        centreButton.setImageTintList(ColorStateList.valueOf(Color.WHITE));
...
//        centreButton.setImageResource(R.drawable.test);
